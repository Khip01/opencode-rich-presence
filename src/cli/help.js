...
Options (update):
  ...
  --dev [BRANCH]   Install latest commit on BRANCH (defaults to \`main\`,
                   which is currently v3.2.0). Combine with --repo for
                   forks.
...
Installation (one-time):
  ...
  npm install -g ./opencode-rich-presence-v3.2.0.tgz

  # After install, set up the OpenCode plugin symlink + config:
  opencode-rpc install

  # Why not \`npm install -g Khip01/opencode-rich-presence#v3.2.0\`?
